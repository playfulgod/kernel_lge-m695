...
{
	if (buf == NULL || buf[0] < '0' || buf[0] > '6')
		return -1;

	lge_set_frst_flag(buf[0]-'0');
	return 1;
}
...
module_param_call(write_block, frst_write_block, frst_read_block, NULL, S_IWUSR | S_IRUSR | S_IWGRP | S_IRGRP);
