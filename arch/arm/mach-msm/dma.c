...
// daewon.seo@lge.com 20120109 [Start] modem DOG issue - msm_dma_add_proper_handling_of_spurious_interrupts.patch
	unsigned int valid = 0;
// daewon.seo@lge.com 20120109 [End] modem DOG issue - msm_dma_add_proper_handling_of_spurious_interrupts.patch
	struct msm_dmov_cmd *cmd;
